...
def _load() -> dict[str, Type[SiteAdapter]]:
    ...
    from .buckydrop import BuckydropAdapter
    ...
    from .greetbuy import GreetbuyAdapter
    from .liuhuamall import LiuhuamallAdapter
    ...
    classes = [
        ...
        TemuAdapter, GreetbuyAdapter, LiuhuamallAdapter, BuckydropAdapter,
    ]
